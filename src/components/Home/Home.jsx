    ...
    return (
        <div className="introPage">
            <div id="intro"> 
                ...
                <span id="intro-summary">I am a highly motivated, self-starting developer with an objective to utilize my skills in web design and development to create engaging and user-friendly interfaces for websites and applications, while keeping up with the latest trends and technologies in the field. I aim to work collaboratively with cross-functional teams to deliver high-quality products that meet client and user needs.</span>
                <div id="resume-link">
